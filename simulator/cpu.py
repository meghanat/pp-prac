...
class CPU:
    def __init__(self, num_processes, page_num_stream, event_page_stream):
...
def start_CPU(num_processes, page_num_stream, event_page_stream):
    mCPU = CPU(num_processes, page_num_stream, event_page_stream)
    try:
